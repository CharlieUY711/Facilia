...
precio_mensual =
  costo_mensual × (1 + MARGEN_COMERCIAL / 100)`}
            ...
            <div className="rounded-xl border border-orange-200 bg-orange-50/50 p-5">
              <p className="text-base font-semibold uppercase tracking-wide text-orange-700 mb-2">
              ...
              <p className="text-lg text-ink/70 leading-relaxed">
                ...
                de FACILIA. El motor nuevo (<code className="text-base">lib/cotizador/engine.ts</code>) sigue
