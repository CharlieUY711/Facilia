  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-navy-50/60 to-paper">
        ...
        <div className="relative max-w-5xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
          <h1 className="font-display font-bold text-navy leading-[1.05] mb-6 animate-fadeUp">
            <span className="block text-2xl sm:text-4xl whitespace-nowrap">No vendemos productos. No vendemos horas.</span>
            <span className="block text-2xl sm:text-4xl text-orange">Entregamos continuidad operativa.</span>
          </h1>
      ...
      {/* Servicios */}
      <section id="servicios" className="max-w-5xl mx-auto px-5 sm:px-8 py-20">
