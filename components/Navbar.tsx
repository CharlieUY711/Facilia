    ...
    <header className="sticky top-0 z-40 bg-paper/80 backdrop-blur-md border-b border-navy-100/50">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <Image src="/FACILIA_By.png" alt="FACILIA — Facility Services by ODDY" width={130} height={34} priority />
        </Link>
        <nav className="hidden sm:flex items-center gap-8 font-body text-sm text-navy/80">
          ...
          <Link href="/panel/login" className="hover:text-orange transition-colors">Dashboard</Link>
          <Link
            href="/cotizador"
